...
# Controllers
CONTROLLER_CMD="ros2 launch evolo_controllers evolo_controllers_launch.py closed_loop_p_gain:=1.5 closed_loop_i_gain:=0.05 closed_loop_d_gain:=0.5 max_steering_output:=100.0 max_integral:=10.0"
